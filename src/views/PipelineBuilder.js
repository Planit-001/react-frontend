...
const initialData = {
    tasks: {
      'task-1': { id: 'task-1', content: 'This' },
      'task-2': { id: 'task-2', content: 'is a' },
      'task-3': { id: 'task-3', content: 'demo' },
      'task-4': { id: 'task-4', content: 'of a future' },
      'task-5': { id: 'task-5', content: 'pipeline builder' },
      'task-6': { id: 'task-6', content: 'in development' },
    },
    columns: {
      'column-1': {
        id: 'column-1',
